...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_GPIO_WritePin(GPIOB, SPKR1_MIC2_RLY_Pin | SPKR2_JACK_RLY_Pin, GPIO_PIN_SET);

	  HAL_Delay(1000);
	  HAL_GPIO_WritePin(GPIOB, SPKR1_MIC2_RLY_Pin | SPKR2_JACK_RLY_Pin, GPIO_PIN_RESET);
